...
public class OutputWindowsStorage {
	...
	private  static String[] used_hdd_space = new String[findRecord()];
	...
	public static int findRecord(){
		...
		int number = f.countRecord("windows_record");
		return number;
	}
	...
	public void inputUsedHddSpace(String usedHddSpace,int i){
		used_hdd_space[i] = usedHddSpace;
	}
	public String[] outputUsedHdd(){
		return used_hdd_space;
	}
