...
public class SnmpUtility {
    ...
    public Object get(OID oid, String ip, String community) {
        Object ret = null;
        ...
        try {
            ...
            Address address = GenericAddress.parse(this.getTransportProtocol() + ":" + ip + "/" + this.getSnmpPort());
        ...
        if(ret == null){
        	JOptionPane.showMessageDialog(null, "Incorrect ip or community");
        }
        return ret;
    }

    /*public List<VariableBinding> getList(List<OID> oid_list) {
    ...
    /*public boolean set(OID oid, Variable value) {
        boolean ret = false;
        TransportMapping transport;
        try {
            if (this.getTransportProtocol().equalsIgnoreCase("UDP")) {
    ...
    public List<VariableBinding> walk(OID oid, String ip, String community) {
        List<VariableBinding> ret = new ArrayList<VariableBinding>();
